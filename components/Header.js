        ...
        <ul className="flex">
          <li className="flex items-center">
            <Link rel="stylesheet" to="#" href="#">
              <a className="py-10 mr-9 uppercase text-white text-xs links">
                <span className="font-bold mr-2 mmd:hidden">00</span> Home</a>
            </Link>
          </li>
          <li className="flex items-center">
            <Link rel="stylesheet" to="#" href="#">
              <a className="py-10 mr-9 uppercase text-white text-xs links">
                <span className="font-bold mr-2 mmd:hidden">01</span> Destination</a>
            </Link>
          </li>
          <li className="flex items-center">
            <Link rel="stylesheet" to="#" href="#">
              <a className="py-10 mr-9 uppercase text-white text-xs links">
                <span className="font-bold mr-2 mmd:hidden">02</span> Crew</a>
            </Link>
          </li>
          <li className="flex items-center">
            <Link rel="stylesheet" to="#" href="#">
              <a className="py-10 uppercase text-white text-xs links">
                <span className="font-bold mr-2 mmd:hidden">03</span> Technology</a>
            </Link>
          </li>
        </ul>
      </nav>
